...
registerOnClick('plan1', false, false, [0,1,2], false, function(event) {
    replaceTexture('Material.006', 'jallllsk.webp', 'c61917234296455.Y3JvcCwxMjc4LDEwMDAsNjAsMA.jpg', false, function() {});
}, function(event) {});
registerOnClick('plan2', false, false, [0,1,2], false, function(event) {
    replaceTexture('Material.007', 'sesion 8_Mesa de trabajo 1.jpg', '37631a229927933.686dade7f3f5d.jpg', false, function() {});
}, function(event) {});
registerOnClick('plan3', false, false, [0,1,2], false, function(event) {
    replaceTexture('Material.009', 'Imagen de WhatsApp 2025-09-01 a las 23.05.01_3930b4d4.jpg', '37631a229927933.686dade7f3f5d.jpg', false, function() {});
}, function(event) {});
registerOnClick('plan4', false, false, [0,1,2], false, function(event) {
    replaceTexture('Material.010', '3fc27a229927933.686dade801969.png', '53fd07229927933.686dade8010e1.png', false, function() {});
}, function(event) {});
registerOnClick('plan 5', false, false, [0,1,2], false, function(event) {
    replaceTexture('Material.005', '8989ee229143991.Y3JvcCwxMjc4LDEwMDAsNjAsMA.png', 'ba4f55229927933.686dade8046b1.png', false, function() {});
}, function(event) {});
